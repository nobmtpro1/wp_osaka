...
if (!class_exists('Ship_Depot_Custom_Admin_Order_Fields')) {
    class Ship_Depot_Custom_Admin_Order_Fields
    {
        ...
        function sd_admin_billing_fields($billing_fields)
        {
            ...
            $option_dt = array('' => SD_SELECT_DISTRICT_TEXT) + Ship_Depot_Address_Helper::get_all_district_key_value(get_post_meta(get_the_ID(), '_shipping_city', true));

            $option_wd = array('' => SD_SELECT_WARD_TEXT) + Ship_Depot_Address_Helper::get_all_wards_key_value(get_post_meta(get_the_ID(), '_shipping_city', true), get_post_meta(get_the_ID(), '_shipping_district', true));
