...
if (!class_exists('Ship_Depot_Custom_Order_Fields')) {
    class Ship_Depot_Custom_Order_Fields
    {
        ...
        function sd_woocommerce_order_formatted_billing_address($raw_address, $order)
        {
            ...
            $option_dt =  Ship_Depot_Address_Helper::get_all_district_key_value(get_post_meta($order_id, '_billing_city', true));
            ...
            $option_wd = Ship_Depot_Address_Helper::get_all_wards_key_value(get_post_meta($order_id, '_billing_city', true), get_post_meta($order_id, '_billing_district', true));
            $raw_address['ward'] = '';
        ...
        function sd_woocommerce_order_formatted_shipping_address($raw_address, $order)
        {
            ...
            $option_dt =  Ship_Depot_Address_Helper::get_all_district_key_value(get_post_meta($order_id, '_shipping_city', true));
            $raw_address['district'] = '';
            ...
            $option_wd = Ship_Depot_Address_Helper::get_all_wards_key_value(get_post_meta($order_id, '_shipping_city', true), get_post_meta($order_id, '_shipping_district', true));
            $raw_address['ward'] = '';
