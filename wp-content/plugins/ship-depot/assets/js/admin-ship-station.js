jQuery(document).ready(function ($) {
    ...
    if ($('.sl_province').length > 0) {
        $('.sl_province').change(function () {
            ...
            selectDistrict.html('<option>' + sd_admin_address_params.l10n.loading + '</option>').attr('disabled', true)
    ...
    if ($('.sl_district').length > 0) {
        $('.sl_district').change(function () {
            ...
            if (selectedDistrict && selectedDistrict > 0) {
                selectStation.html('<option>' + sd_ship_station_params.l10n.loading + '</option>').attr('disabled', true)
