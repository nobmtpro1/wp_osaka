...
<div class="sd-div sd-setting" id="sd-about">
	...
	<p class="description"><?php esc_html_e('Miễn phí đối với plugin và một số tính năng. Xem thêm chi tiết tại ', 'ship-depot-translate') ?>
		<a href="<?php echo esc_url(SHIP_DEPOT_SITE) ?>/license" target="_blank"><?php echo esc_url(SHIP_DEPOT_SITE) ?>/license</a>
	</p>
