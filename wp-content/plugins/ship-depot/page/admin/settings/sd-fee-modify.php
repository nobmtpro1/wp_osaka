                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-xl-2 col-lg-5 col-md-12 custom-col div-fee-option">
                                    ...
                                    <input name="${feeIndex}[feeOption][value]" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" class="fee_option_val" placeholder="<?php esc_attr_e('Ví dụ: 1,5', 'ship-depot-translate') ?>" value="" />
                                </div>
                ...
                if (selectedValue == 'total_amount') {
                    ...
                    <div>
                        ...
                        <div class="container-fluid">
                                <div class="row">
                                    <div class="col-6">
                                        <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="${if_name}[from]" id="${if_id}_from" placeholder="<?php esc_attr_e('Từ (vnđ)', 'ship-depot-translate'); ?>"  />
                                    </div>
                                    <div class="col-6">
                                        <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="${if_name}[to]" id="${if_id}_to" placeholder="<?php esc_attr_e('Đến (vnđ)', 'ship-depot-translate'); ?>"  />
                                    </div>
                                </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="container-fluid">
                                <div class="row">
                                    <div class="col-6">
                                        <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="${if_name}[from]" id="${if_id}_from" placeholder="<?php esc_attr_e('Từ (SL)', 'ship-depot-translate'); ?>" />
                                    </div>
                                    <div class="col-6">
                                        <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="${if_name}[to]" id="${if_id}_to" placeholder="<?php esc_attr_e('Đến (SL)', 'ship-depot-translate'); ?>" />
                                    </div>
                                </div>
                        </div>
                    </div>
...
<div class="sd-div sd-setting" id="sd-fee-modify">
    ...
    <p class="description">
        <?php esc_html_e('Còn nhiều kịch bản khác, có thể xem thêm tại', 'ship-depot-translate') ?>
        <a href="<?php echo esc_url(SHIP_DEPOT_SITE) ?>/how-to-use-fee-modification" target="_blank"><?php echo esc_url(SHIP_DEPOT_SITE) ?>/how-to-use-fee-modification</a>
    </p>
    <p class="description">
                            ...
                            <div class="container-fluid">
                                <div class="row" class="all-conditions-group">
                                                        ...
                                                        <div class="condition_table" id="condition_table_<?php echo esc_attr($id) ?>">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="<?php echo esc_attr($if_name) . '[from]' ?>" id="<?php echo esc_attr($if_id) . '_from' ?>" placeholder="<?php esc_attr_e('Từ (vnđ)', 'ship-depot-translate') ?>" value="<?php echo $order_condition->FromValue == -9999 ? "" : esc_attr(Ship_Depot_Helper::currency_format($order_condition->FromValue, "")) ?>" />
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="<?php echo esc_attr($if_name) . '[to]' ?>" id="<?php echo esc_attr($if_id) . '_to' ?>" placeholder="<?php esc_attr_e('Đến (vnđ)', 'ship-depot-translate') ?>" value="<?php echo $order_condition->ToValue == -9999 ? "" : esc_attr(Ship_Depot_Helper::currency_format($order_condition->ToValue, "")) ?>" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="condition_table" id="condition_table_<?php echo esc_attr($id) ?>">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="<?php echo esc_attr($if_name) . '[from]' ?>" id="<?php echo esc_attr($if_id) . '_from' ?>" placeholder="<?php esc_attr_e('Từ (SL)', 'ship-depot-translate') ?>" value="<?php echo $order_condition->FromValue == -9999 ? "" : esc_attr(Ship_Depot_Helper::currency_format($order_condition->FromValue, "")) ?>" />
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="<?php echo esc_attr($if_name) . '[to]' ?>" id="<?php echo esc_attr($if_id) . '_to' ?>" placeholder="<?php esc_attr_e('Đến (SL)', 'ship-depot-translate') ?>" value="<?php echo $order_condition->ToValue == -9999 ? "" : esc_attr(Ship_Depot_Helper::currency_format($order_condition->ToValue, "")) ?>" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-xl-2 col-lg-5 col-md-12 custom-col div-fee-option">
                                        ...
                                        <input name="<?php echo esc_attr($fee_index) . '[feeOption][value]' ?>" class="fee_option_val" placeholder="<?php esc_html_e('Ví dụ: 1,5', 'ship-depot-translate') ?>" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" value="<?php echo esc_attr(Ship_Depot_Helper::currency_format($fee->Option->Value, "")) ?>" />
                                    </div>
                                    <!-- Khoảng thời gian -->
                                    <div class="col-xl-2 col-lg-7 col-md-12 custom-col div-time-apply">
