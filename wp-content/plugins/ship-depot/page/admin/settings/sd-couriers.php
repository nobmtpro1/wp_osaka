                                ...
                                <div class="container-fluid col-padding-0">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-8 col-md-8 col-sm-12 grid-cell div-cod-failed-amount">
                                            <input pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" type="text" name="<?php echo esc_attr($courier->CourierID) ?>[CODFailed][CODFailedAmount]" value="<?php echo esc_attr(Ship_Depot_Helper::currency_format($st_courier->CODFailed->CODFailedAmount, '')) ?>" class="cod-failed-value" />
